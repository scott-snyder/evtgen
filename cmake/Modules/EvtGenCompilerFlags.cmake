...
if(DEFINED ENV{CMAKE_CXX_STANDARD})
    ...
    elseif($ENV{CMAKE_CXX_STANDARD} LESS ${EVTGEN_CXX_STANDARD})
        message(WARNING "EvtGen: Version of C++ standard requested via CMAKE_CXX_STANDARD environment variable, C++$ENV{CMAKE_CXX_STANDARD}, is below required minimum of C++${EVTGEN_CXX_STANDARD}, not changing it")
    endif()
endif()
